...
public class Controller {
    ...
    public void controllerActive(Player player) {
            ...
            for (int j = 0; j < mapData.getCols(); j++) {
                switch (charMap[i][j]) {
                    ...
                    case '6':
                        ...
                        break;
                    case '+':
                        if (this.playerStartX != -1 && this.playerStartY != -1) {
    ...
    public void updateForAll(double deltaTime, Player player) {
        // --- Vòng lặp Update ---
    ...
    public void renderForAll(Player player) {
        // --- Vòng lặp Render ---
